...
function Mobile(){function t(t){t.showMobile(!0);t.showMenu(!1);n.showLogIn(!1);n.showRegister(!1);n.showProfile(!1);n.showChangePassword(!1);n.showHistory(!1);n.forceClickRegister()||resetUrlFromRegister()}var n=this;n.showLogIn=ko.observable(!1);n.showRegister=ko.observable(!1);n.showProfile=ko.observable(!1);n.showChangePassword=ko.observable(!1);n.showHistory=ko.observable(!1);n.logInSuccessed=ko.observable(!1);n.showAccountSelect=ko.observable(!0);n.forceClickRegister=ko.observable(!1);n.clickMenu=function(i,r){var u=r.target.innerText.trim();t(i);switch(u){case cMobileMenuHome:i.showMobile(!1);i.showCheckOut(!1);i.showMain(!0);n.showHistory(!1);break;case cMobileMenuLogIn:n.showLogIn(!0);i.showCheckOut(!1);i.showMain(!1);n.showHistory(!1);n.showAccountSelect(!1);break;case cMobileMenuRegister:n.showRegister(!0);i.showCheckOut(!1);i.showMain(!1);n.showHistory(!1);n.showAccountSelect(!1);n.forceClickRegister(!1);break;case cMobileMenuProfile:n.showProfile(!0);i.showCheckOut(!1);i.showMain(!1);n.showHistory(!1);break;case cMobileMenuChangePassword:n.showChangePassword(!0);i.showCheckOut(!1);i.showMain(!1);n.showHistory(!1);break;case cMobileMenuHistory:n.showHistory(!0);n.showChangePassword(!1);i.showCheckOut(!1);i.showMain(!1);break;case cMobileMenuLogOff:i.showMobile(!1);i.showCheckOut(!1);i.showMain(!1);getIdTag(cfrmLogOff).submit();break;default:i.showMobile(!1);i.showCheckOut(!1);i.showMain(!0)}setScrollTop();$(".ssm-toggle-nav")[0].click()}}
function DeskTop(){self=this;self.customerName=ko.observable("");self.logInSuccessed=ko.observable(!1)}
$(document).ready(function(){$("body").addClass("loaded");$("#loader-shimmer").hide();$("#btnBackToHome").click(function(){var n=$("#divHomeViewIndex").data("request-url");location.href=n})});
$(document).ready(function(){setTimeout(function(){function o(n,t,i,r,u,f,e,o,s,h,c,l,a,v,y,p){try{var w=this;w.showTermsAndCondition=ko.observable(!1);w.showPrivacyProlicy=ko.observable(!1);window.location.hash.includes("TermsAndConditions")?(w.showTermsAndCondition(!0),$("#termsAndCondition").show(),$("#privacyProlicy").hide(),$("#loader-shimmer").hide(),$("#koMenuView").hide(),$("body").removeClass("loading")):window.location.hash.includes("PrivacyPolicy")?(w.showPrivacyProlicy(!0),$("#privacyProlicy").show(),$("#termsAndCondition").hide(),$("#loader-shimmer").hide(),$("#koMenuView").hide(),$("body").removeClass("loading")):($("#loader-shimmer").show(),$("#koMenuView").show(),$("#privacyProlicy").hide(),$("#termsAndCondition").hide(),w.showMobile=ko.observable(!1),w.showMenu=ko.observable(!0),w.showMain=ko.observable(!0),w.showCheckOut=ko.observable(!1),w.disableBtnSubmit=ko.observable(!1),w.apiKey=ko.observable(l),w.apiKeyEmergepay=ko.observable(a),w.paymentServiceProvider=ko.observable(parseInt(y)),w.reCaptchaSiteKey=ko.observable(p),w.currentDatetime=ko.observable(n),w.currentDay=ko.observable(t),w.logInFb=isEmpty(i)?ko.observable(!1):ko.observable(!0),w.loading=new LoadingViewModel,w.customer=new CustomerViewModel(u),w.changePassword=new ChangePasswordViewModel,w.globalConfig=new GlobalConfigViewModel(r),w.giftCerImages=new GiftCerImagesViewModel(f,e,o),w.giftCerAmount=new GiftCerAmountViewModel(s),w.giftCerCustomDiscount=new GiftCerCustomDiscount(h),w.giftCerDetail=new GiftCerDetailViewModel(c,n),w.guestLogin=new GuestViewModel,w.cart=new CartViewModel(c,n,v),w.checkout=new CheckOutViewModel,w.orderHistory=new OrderHistoryViewModel,w.giftCardDetail=new GiftCardDetailViewModel,w.mobile=new Mobile,w.desktop=new DeskTop,isEmpty(u)||(w.desktop.logInSuccessed(!0),w.mobile.logInSuccessed(!0)))}catch(b){logErrorJavaScript(b,"home-index.js/viewModel",123,!0)}}function n(n,t){var i=new ObjUrl(n),r=i.getUrlFromJson(),u=JSON.parse('{"key" : "'+t+'"}');return getJsonFromAjaxAddHeader(r,!ajax_async,ajax_cache,ajax_type_post,u,ajax_timeout,token())}var u,v,e,h,ot,st,c,ht,ct;if(window.onerror=function(n,t,i){return t.indexOf("inject.js")!=-1&&logErrorJavaScript(n,t,i,!1),!0},u="?2026072104",!window.location.search.includes(u)){var f=window.location.search,l=f.startsWith("?")?f.substring(1):f,lt=window.location.pathname=="/"?"/":window.location.pathname+"/",a=window.location.protocol+"//"+window.location.host+lt+u;isEmpty(l)||(a+="&"+l);window.history.replaceState({},"",a)}if(v=new URLSearchParams(window.location.search),e=v.get("giftcard"),isEmpty(e)||showGiftCardDetail(e),window.location.hash.includes("TermsAndConditions")||window.location.hash.includes("PrivacyPolicy"))vmViewIndex=new o;else{var t=JSON.parse(n(cJsonGetDateTime,"")),i=$("#divVarAuthenticated").val(),y=$("#divVarLogInType").val(),at=$("#divVarCustomerKey").val(),s="",r="";s=t.currentDay.length==0?$("#divVarCurrentDay").val():t.currentDay;r=t.currentDateTime.length==0?$("#divVarCurrentDateTime").val():t.currentDateTime;var vt=convertStrToBool($("#divVarShowResetPasswordForm").val()),yt=convertStrToBool($("#divVarConfirmAccount").val()),pt=convertStrToBool($("#divVarDeleteAccount").val()),p=$("#divVarConfirmToken").val(),w=$("#divModelGlobalConfig").val(),b=$("#divModelGiftCerImagesMobile").val(),k=$("#divModelGiftCerImagesTablet").val(),d=$("#divModelGiftCerImagesDesktop").val(),g=$("#divModelGiftCerValue").val(),nt=$("#divModelGiftCerCustomDiscount").val(),tt=$("#divModelGiftCerSendType").val(),it=$("#divApiKey").val(),rt=$("#divApiKeyEmergepay").val(),ut=$("#divVarPaymentServiceProvider").val(),ft=$("#divVarReCaptchaSiteKey").val(),wt=$("#divErrorServerMaintenance").data("request-url"),et=!1;isEmpty(i)?vmViewIndex=new o(r,s,y,w,null,b,k,d,g,nt,tt,it,rt,null,ut,ft):(h=n(cJsonGetHeaderToken),h!=null&&(ot=JSON.parse(h),$("#divVarHeader").val(ot)),st=n(cJsonGetCustomer,at),c=JSON.parse(st),et=c.isCustomerBlacklisted,ht=JSON.stringify(c.customerProfile),ct=n(cJsonGetCustomerAddressBilling,i),vmViewIndex=new o(r,s,y,w,ht,b,k,d,g,nt,tt,it,rt,ct,ut,ft))}if(!vmViewIndex.showTermsAndCondition()&&!vmViewIndex.showPrivacyProlicy()){_currentTime=moment(r,moment_date_format_mmddyyyyhhmmssa);setInterval(function(){e()},6e4);koBindingHandlers();ko.applyBindings(vmViewIndex,document.getElementById("koMenuView"));refreshStore();renderCaptcha();isEmpty(i)||u(vmViewIndex.customer.customerId(),!1);$("nav.nav-mobile").slideAndSwipe();$("#frmConfirmPayment").card({container:".card-wrapper",messages:{validDate:"expire\ndate",monthYear:"mm/yyyy"},width:200,placeholders:{number:"•••• •••• •••• ••••",name:"Full Name",expiry:"••/••••",cvc:"•••"},masks:{cardNumber:"•"}});setBlockEmoji();setInputCustomAmountNumeric();checkDisableCheckboxDelivery();setGeoLocation();$(document).on("submit","form",function(){var r,u,i;if(!checkInternetConnection())return r=new ObjAlert(n,cError_Fail_NoInternet,!1),r.getAlert(),!1;var o=$(this),n=o.attr("id"),s=$(this).parent(),t=new ObjValidateForm(n,s);if(t.verifyData(),t.error.length>0)return t.showAlert&&(u=convertArrToString(t.error),swal(cSwal_Alert_Error,replaceNewLineToBr(u),cSwal_Icon_Error)),!1;addSpinButton(n);vmViewIndex.disableBtnSubmit(!0);var h=$(this).serialize(),c=new ObjUrl(n),e=c.getUrlSubmitForm();return isEmpty(e)?(swal(cSwal_Alert_Error,cError_Dev_Url,cSwal_Icon_Error),!1):(i=$.ajax({url:e,"async":ajax_async,cache:ajax_cache,type:ajax_type_post,data:h,timeout:ajax_timeout,headers:{RequestVerificationToken:token()}}),i.done(function(i){var r;i.status&&f(n,i);t.showAlert&&(n==cfrmConfirmPayment||n==cfrmDiscount?i.status||(i.obj=="redirect"?swal("",i.message,cSwal_Icon_Error).then(function(){redirectMain()},function(){}):(r=new ObjAlert(n,i.message,i.status),r.getAlert())):n==cfrmLogIn||n==cfrmRegister||n==cfrmGuestLogin?(n==cfrmRegister&&vmViewIndex.globalConfig.captchaEnable()&&resetCaptCha(),i.status?(r=new ObjAlert(n,i.message,i.status),r.getAlert()):isEmpty(i.message)||i.message.toLowerCase()!=cError_Customer_Blacklist.toLowerCase()?(r=new ObjAlert(n,i.message,i.status),r.getAlert()):swalErrorCustomerBlacklist()):(r=new ObjAlert(n,i.message,i.status),r.getAlert()));vmViewIndex.disableBtnSubmit(!1);removeSpinButtonNextUser();removeSpinButton(n)}),i.fail(function(){vmViewIndex.disableBtnSubmit(!1);removeSpinButtonNextUser();removeSpinButton(n);var t=new ObjAlert(n,cError_Fail_TimeOut,!1);t.getAlert()}),!1)});function f(t,i){var o,r,f,e;switch(t){case cfrmLogIn:case cfrmRegister:try{f=n(cJsonGetHeaderToken);f!=null&&(e=JSON.parse(f),$("#divVarHeader").val(e));const s=$("#modalCaptchaLogin").is(":visible");s&&$("#modalCaptchaLogin").modal("hide");const h=$("#modalCaptchaRegister").is(":visible");h&&$("#modalCaptchaRegister").modal("hide");ko.mapping.fromJSON(i.obj,{},vmViewIndex.customer);u(vmViewIndex.customer.customerId(),!0);vmViewIndex.customer.profileUpdate.firstName(vmViewIndex.customer.firstName());vmViewIndex.customer.profileUpdate.lastName(vmViewIndex.customer.lastName());vmViewIndex.customer.profileUpdate.ownerPhone(vmViewIndex.customer.ownerPhone());o=n(cJsonGetCustomerAddressBilling,vmViewIndex.customer.customerId());isEmpty(o)||o=="null"||(r=new CustomerAddressBillingCurrentViewModel(JSON.stringify(JSON.parse(o))),vmViewIndex.cart.ccBillingAddress(r.address()),vmViewIndex.cart.billingAddressLatitude(r.latitude()),vmViewIndex.cart.billingAddressLongitude(r.longitude()),vmViewIndex.cart.billingAddressCity(r.city()),vmViewIndex.cart.billingAddressSubCity(""),vmViewIndex.cart.billingAddressState(r.state()),vmViewIndex.cart.ccBillingZip(r.postTal()));vmViewIndex.desktop.logInSuccessed(!0);vmViewIndex.mobile.logInSuccessed(!0);vmViewIndex.checkout.step()==0?(vmViewIndex.showMobile(!1),vmViewIndex.showMain(!0),vmViewIndex.showCheckOut(!1)):(vmViewIndex.showMobile(!1),vmViewIndex.showMain(!1),vmViewIndex.showCheckOut(!0),setGeoLocation());t==cfrmLogIn?$(".popover-login").popover("hide"):$(".popover-register").popover("hide");checkAuthenticationExpiration()}catch(s){logErrorJavaScript(s,"home-index.js/cfrmRegister",417,!0)}break;case cfrmLogOff:location.replace(i.url);break;case cfrmForgotPassword:$("#modalForgotPassword").modal("hide");break;case cfrmResetPassword:$("#modalResetPassword").modal("hide");break;case cfrmCustomerProfileUpdate:vmViewIndex.customer.firstName(vmViewIndex.customer.profileUpdate.firstName());vmViewIndex.customer.lastName(vmViewIndex.customer.profileUpdate.lastName());vmViewIndex.customer.ownerPhone(vmViewIndex.customer.profileUpdate.ownerPhone());break;case cfrmChangePassword:vmViewIndex.changePassword.oldPassword("");vmViewIndex.changePassword.newPassword("");vmViewIndex.changePassword.confirmPassword("");break;case cfrmLogOff:location.replace(i.url);break;case cfrmGuestLogin:f=n(cJsonGetHeaderToken);f!=null&&(e=JSON.parse(f),$("#divVarHeader").val(e));const h=$("#modalCaptchaGuest").is(":visible");h&&$("#modalCaptchaGuest").modal("hide");ko.mapping.fromJSON(i.obj,{},vmViewIndex.guestLogin);vmViewIndex.guestLogin.guestId().length>0&&vmViewIndex.checkout.clickNextUser()}}$("html").on("mouseup",function(n){$(n.target).closest(".popover").length||$(n.target).attr("id")=="btnCheckOut"||$(n.target).text()=="Check Out"||$(n.target).text()=="OK"||$(".popover").each(function(){$("[data-original-title]").popover("hide");$(".popover-login").blur()})});$(window).resize(function(n){isTouchDevice()||($(n.target).closest(".popover").length||$(n.target).attr("id")=="btnCheckOut"||$(n.target).text()=="Check Out"||$(n.target).text()=="OK"||$(".popover").each(function(){$("[data-original-title]").popover("hide");$(".popover-login").blur()}),t())});t();$(window).scroll(function(){var i=$(window).scrollTop(),r=isDevice(),e=r=="mobile"||r=="phablet",f;if(e)$(".panel-cart").stop().animate({top:0});else{var n=$(window).outerHeight(!0),o=$(".panel-cart").offset(),t=$(".panel-cart").outerHeight(!0),s=t+o.top-90,u=$(".footer").outerHeight(!0);(t>=n||s>n-u)&&(f=t-n+u+100,$(".panel-cart").stop().animate({top:-f}));i<100&&$(".panel-cart").stop().animate({top:90})}i>300?($(".backToTop").addClass("show"),$(".footer-nav").removeClass("d-none")):($(".backToTop").removeClass("show"),$(".footer-nav").addClass("d-none"))});$(".cardPreview .header .character").hide();$(".cardDetail .mobile .preview").hide();$("#modalCaptchaRegister").on("hidden.bs.modal",function(){resetUrlFromRegister()});setTimeout(function(){if($("body").removeClass("loading"),$("body").addClass("loaded"),$("#loader-shimmer").hide(),$(".viewLoading").removeClass("gb_hidden"),$(".amount.slick-slider").slick("setPosition"),isEmpty(i)){if(window.location.pathname.toLowerCase().includes("register")){checkMobileForResolution()?(vmViewIndex.mobile.forceClickRegister(!0),$(".ssm-toggle-nav").click(),$("#mobile-menu-register").click()):$("#modalCaptchaRegister").modal("show");return}}else resetUrlFromRegister();if(et)return swalErrorCustomerBlacklist(!0),!1;vt&&($("#modalResetPassword").modal({backdrop:"static",keyboard:!1}),$("#modalResetPassword").modal("hide"),$("#modalResetPassword").modal("show"));yt?(vmViewIndex.loading.loadingVisible(!0),callBackAccountConfirm(p,!0)):pt&&(vmViewIndex.loading.loadingVisible(!0),callBackAccountConfirm(p,!1));var n=checkVersionIE();isEmpty(n)||n<11&&$("#browserVerionModel").modal("show");$(".cardPreview .header .character").show();$(".cardPreview .header .character span").addClass("keyframe");$(".cardPreview .mobile .preview").addClass("animated fadeInUp");$(".cardPreview .tablet .border-slice-horizontal").addClass("border-transition");checkAuthenticationExpiration()},0);function e(){_currentTime.add(1,moment_minute)}function t(){var n=$(window).width();n>=576?$(".jp-card-container").css({transform:"scale(0.9)"}):$(".jp-card-container").css({transform:"scale(0.5)"})}function u(t){var r=n(cJsonGetOrderHistory,t),i;r.length>0&&(i=JSON.parse(r),isEmpty(i.result)||(ko.utils.arrayForEach(i.result.giftCerDataRaw,function(n){var t=ko.utils.arrayFilter(i.result.giftCerOrders,function(t){return t.giftCode==n.giftCode}),r=ko.utils.arrayFilter(i.result.giftCerImages,function(n){return n.giftCerImagesId==_.first(t).giftCerImagesId});vmViewIndex.orderHistory.data.push(new DataOrderHistoryModel(n,_.first(t),_.first(r)))}),ko.cleanNode(document.getElementById($("#modalHistory").attr("id"))),ko.applyBindings(vmViewIndex,document.getElementById($("#modalHistory").attr("id"))),ko.utils.arrayForEach(i.result.giftCerOrders,function(n){$("#item-barcode"+n.giftCode).barcode(n.giftCode,"code128");$("#item-barcode-mobile"+n.giftCode).barcode(n.giftCode,"code128")})))}giftCardDetail();eventModal()}},250)});
